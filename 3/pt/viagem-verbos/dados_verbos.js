...
const dbVerbos = {
  ...
  nivel3: [
    {
      id: "textoA",
      texto: `O nosso navio <span class="palavra-alvo-l3" data-palavra="partiu">partiu</span> do porto bem cedo. Nós <span class="palavra-alvo-l3" data-palavra="comemos">comemos</span> peixe fresco ao almoço. O capitão <span class="palavra-alvo-l3" data-palavra="escreve">escreve</span> as novidades no livro de bordo. Amanhã, nós <span class="palavra-alvo-l3" data-palavra="veremos">veremos</span> os golfinhos no mar alto. Os marinheiros de vigia <span class="palavra-alvo-l3" data-palavra="sorriem">sorriem</span> felizes.`,
    ...
    {
      id: "textoB",
      texto: `A nossa tripulação <span class="palavra-alvo-l3" data-palavra="trabalhou">trabalhou</span> muito na limpeza do convés. Eu <span class="palavra-alvo-l3" data-palavra="bebo">bebo</span> água bem fresca para o calor. Tu <span class="palavra-alvo-l3" data-palavra="subirás">subirás</span> ao mastro mais logo para vigiar. Ontem, o vento <span class="palavra-alvo-l3" data-palavra="soprou">soprou</span> com pouca força. Nós <span class="palavra-alvo-l3" data-palavra="adoramos">adoramos</span> a bela vida no grande oceano.`,
      alvos: ["trabalhou", "bebo", "subirás", "soprou", "adoramos"],
      dica: "Descobre os 5 verbos: procura as palavras que descrevem ações dos marinheiros ou do vento! ⚓"
    },
    {
      id: "textoC",
      texto: `O experiente capitão <span class="palavra-alvo-l3" data-palavra="pôs">pôs</span> o chapéu na cabeça. Os marinheiros <span class="palavra-alvo-l3" data-palavra="correm">correm</span> para puxar as cordas. Eu <span class="palavra-alvo-l3" data-palavra="ouvi">ouvi</span> o som das baleias ao longe. Amanhã de manhã, nós <span class="palavra-alvo-l3" data-palavra="pescaremos">pescaremos</span> o nosso jantar. O belo sol <span class="palavra-alvo-l3" data-palavra="brilha">brilha</span> no horizonte azul.`,
      alvos: ["pôs", "correm", "ouvi", "pescaremos", "brilha"],
      dica: "Atenção aos 5 verbos: um terminado em -or (pôr), um de corrida, um de audição, um de pesca futura e um do brilhar do sol! ⚓"
    },
    {
      id: "textoD",
      texto: `O jovem grumete <span class="palavra-alvo-l3" data-palavra="limpa">limpa</span> a mesa de refeições da cabine. O cozinheiro <span class="palavra-alvo-l3" data-palavra="assou">assou</span> um belo peixe capturado ontem. Os piratas <span class="palavra-alvo-l3" data-palavra="proporão">proporão</span> um acordo de paz ao capitão. Nós <span class="palavra-alvo-l3" data-palavra="dormimos">dormimos</span> sob as estrelas brilhantes. O navio <span class="palavra-alvo-l3" data-palavra="desliza">desliza</span> suavemente.`,
